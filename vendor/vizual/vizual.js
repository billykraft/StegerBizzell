...
var editableScriptPage = window.location.origin + '/stegerbizzell/public/vizual';
	...
	for(var i = 0; i < str.length; i++){
		if( str[i] == '<' ){
			...
			if( i < str.length - 4 ){
				...
				else if( str.substring(i,i+4) == "</b>" ){ okay = true; }
				...
				else if( str.substring(i,i+5) == "</li>" ){ okay = true; }
