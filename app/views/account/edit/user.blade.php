...
{{ Form::model(['action' => 'UsersController@editUserStore']) }}
        <div class="form-group">
            {{ Form::text('first_name', $firstName, array('class' => 'form-control', 'placeholder' => 'First Name') )}}
            {{ $errors->first('first_name', '<span class=alert-danger>:message</span>') }}
        </div>
        <div class="form-group">
            {{ Form::text('last_name', $lastName, array('class' => 'form-control', 'placeholder' => 'Last Name') )}}
            {{ $errors->first('last_name', '<span class=alert-danger>:message</span>') }}
        </div>
        <div class="form-group">
            {{ Form::email('email', $email, array('class' => 'form-control', 'placeholder' => 'Email Address') )}}
